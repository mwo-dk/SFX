...
namespace SFX.CSharp.System.Windows.Model.Product
{
    /// <summary>
    ...
    public struct ProductId : IEquatable<ProductId>
    {
        ...
        /// <summary>
        /// Compares current <see cref="ProductId"/> to <paramref name="other"/>
        /// </summary>
        /// <param name="other">The <see cref="ProductId"/> to be compared against</param>
        /// <returns>True if the <see cref="ProductId"/>s are equal. Else false.</returns>
        ...
        {
            if (obj is null || !(obj is ProductId))
                return false;
